...
TEST(ColorTest, Interpolate) {
  ...
  EXPECT_EQ(Color::Interpolate(0.3, Color(), Color()).Print(false), "39");
  EXPECT_EQ(Color::Interpolate(0.3, Color::Red, Color()).Print(false), "31");
  EXPECT_EQ(Color::Interpolate(0.7, Color::Red, Color()).Print(false), "39");
  EXPECT_EQ(Color::Interpolate(0.3, Color(), Color::Red).Print(false), "39");
  EXPECT_EQ(Color::Interpolate(0.7, Color(), Color::Red).Print(false), "31");

  EXPECT_EQ(Color::Interpolate(0.3,                        //
                               Color::RGB(1, 2, 3),        //
                               Color::RGB(244, 244, 123))  //
                .Print(false),
            "38;2;73;74;39");
  EXPECT_EQ(Color::Interpolate(0.7,                        //
                               Color::RGB(1, 2, 3),        //
                               Color::RGB(244, 244, 123))  //
                .Print(false),
            "38;2;171;171;87");
