  ...
  class Impl : public NodeDecorator {
   public:
    ...
    void ComputeRequirement() override {
      ...
      box.x_min = static_cast<int>(static_cast<float>(requirement_.min_x) * x_);
      box.y_min = static_cast<int>(static_cast<float>(requirement_.min_y) * y_);
      box.x_max = static_cast<int>(static_cast<float>(requirement_.min_x) * x_);
      box.y_max = static_cast<int>(static_cast<float>(requirement_.min_y) * y_);
    }
